...
\caption{Cumulative distribution of the full sample of flares (Sectors 1 and 27) with orbital phase. Phase 0 indicates the transit mid-time of AU Mic b. The underlying expected distribution is uniform, and is modulated by gaps in the phase coverage and detection thresholds of the two light curves.}
\label{fig:cumdist}
\end{figure}
