...
\item Sample $F$ flare occurrence phases from the phase coverage distribution to get a distribution of flare phases, where $F$ is the total number of flares in the data. This step generates a list of flares that are uniformly distributed across all phases.
