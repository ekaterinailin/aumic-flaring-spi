...
\title[]{Searching for flaring star-planet interactions in AU Mic TESS observations}
...
In the about 50 days of observations, the distributions of flares with orbital, rotational, and synodic phases were consistent with intrinsic stellar flaring. We discuss possible physical and observational reasons for the lack of flaring SPI signal in the light curves. We conclude that, if flaring SPI signal is present in the observable energy regime but infrequent, continued monitoring of AU Mic by missions like TESS and PLATO will favor the detection of flaring SPI with orbital phase.
...
The observed distribution of flares does not deviate significantly from a uniform distribution of flares with orbital or synodic period either. The strongest deviation from uniformity, a $\sim1.5\sigma$ detection ($p=0.07,\;n=71$), is seen with $P_{orb}$ in the flares whose energy exceeds $ED=1$\,s, that is, approximately $2.3\cdot10^{31}\,$erg in the TESS band. \citet{howard2021evryflare} detected flaring periodicity in 3 out of 284 late K and M dwarfs observed with TESS, and concluded that flaring periodicity might be rare, difficult to detect, or both. 
...
However, if the suggestive signal in the $ED>1$\,s flares~(Table~\ref{tab:pvals}) indeed stems from flaring SPI, we may be limited mostly by the first observational bias, i.e., insufficient observing time. In this case, the periodically occurring flares are well above the detection threshold of TESS.
...
We do not rule out that, as time series observations of AU Mic accumulate with TESS, and soon PLATO~\citep{rauer2014plato}, SPI-triggered flares can be detected with high significance. We argue that long gaps on time scales of months to years betweeen consecutive light curves will average out rotational variability signal as the spot structure evolves, but will leave a $P_{orb}$-dependent SPI signal intact. 
